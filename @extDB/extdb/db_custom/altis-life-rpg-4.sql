...
SQL1_2 = 		(playerid, name, cash, bankacc, aliases, cop_licenses, med_licenses, hato_licenses, civ_licenses, civ_gear, cop_gear, med_gear, hato_gear)
SQL1_3 = 		VALUES(?,?,?,?,?,?,?,?,?,?,?,?,?);
...
;;
					1		2	  3		 4			5			6			7			  8			9
SQL1_1 = SELECT playerid, name, cash, bankacc, adminlevel, donatorlvl, hato_licenses, hatolevel, hato_gear FROM players WHERE playerid=?;
SQL1_INPUTS = 1
...
;;______________________________________________________________
[playerUpdateHatoLicense]
;;

SQL1_1 = UPDATE players
SQL1_2 = 		SET hato_licenses=? WHERE playerid=?;

SQL1_INPUTS = 1-AltisLifeRPG_Array, 2
Number of Inputs = 2

;;______________________________________________________________
[playerUpdateHatoGear]
;;

SQL1_1 = UPDATE players
SQL1_2 = 		SET hato_gear=? WHERE playerid=?;
...
SQL1_1 = UPDATE players
;;				1          2 	    3          4               5                 6
SQL1_2 = 		SET name=?, cash=?, bankacc=?, hato_licenses=?, hato_gear=? WHERE playerid=?;
