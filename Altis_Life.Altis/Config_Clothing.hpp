...
class Clothing {
	...
	class cop {
		...
		uniforms[] = {
			...
			{ "U_B_HeliPilotCoveralls", "NPAS Only", 25, { "life_coplevel", "SCALAR", 4 } },
			{ "U_NikosBody", "UnderCover Posh", 75, { "life_coplevel", "SCALAR", 6 } },
			{ "U_C_Journalist", "UnderCover Journalist", 75, { "life_coplevel", "SCALAR", 6 } },
			{ "U_C_Poor_1", "UnderCover Poor", 75, { "life_coplevel", "SCALAR", 6 } }
		};
